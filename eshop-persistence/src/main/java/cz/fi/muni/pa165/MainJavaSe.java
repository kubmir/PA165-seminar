...
public class MainJavaSe {
    ...
    private static void task04() {
        ...
        myManager.persist(electronics);
        myManager.persist(musical);
	...
	guitar.setAddedDate(cal1.getTime());
        ...
        try {
            ...
            throw new RuntimeException( "Successfully saved new Product with "
                    + "the same name (Guitar) it should be unique!"); 
        } catch (PersistenceException ex) { 
            System.out.println(
                "Unsuccessfully saved second object with name Guitar -> OK"); 
        } 
